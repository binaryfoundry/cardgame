...
{
    const cardgame::Player winner = game.Play([&](const uint32_t played_round, const int32_t player_1_card, const int32_t player_2_card, const cardgame::Player winner)
    {
